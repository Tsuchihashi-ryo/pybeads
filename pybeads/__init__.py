...
from numba import jit, float64, int64, boolean,string

@jit(float64[:,:](float64[:], int64, float64, float64, int64, float64, float64, float64, string), nopython=True, parallel=True)
